          ...
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              ...
              <p className="2xl:px-20">
                Tech Trend Admin Panel. Only authorized personals are allowed.
              </p>
            ...
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <form>
                ...
                <div className="mb-5 text-center">
                  {loading && <BeatLoader loading color="rgb(60 80 224)"/>}
                {warning && <p className=" text-danger italic text-sm py-2">Invalid Username or Password</p>}
                  <input
                    type="submit"
                    value="Sign In"
